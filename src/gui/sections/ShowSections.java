 ...
 * @author User
 */
public class ShowSections extends DefaultFrame {

    /**
     * Creates new form ShowSections
     */
    public ShowSections() {
        initComponents();
        updateTable();
    ...
    private void initComponents() {
        ...
        jButton1.setText("preview graph");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        try {
            JFrame frame = BarChart.display(getAllCoursesStudentsNumber());
    ...
    private void updateTable() {
        try {
            jTable1.setModel(buildTableModel(getAllCoursesStudentsNumber()));
        } catch (SQLException ex) {
